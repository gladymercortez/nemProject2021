...
namespace MoviesAPI.Tests.UnitTests
{
    ...
    public class AccountsControllerTests : BaseTests
    {
        ...
        private async Task CreateAnUser(string databaseName)
        {
            ...
            var createUserInfo = new CreateUserInfoDTO() { EmailAddress = "example@hotmail.com", Password = "Aa123456!", PhoneNumber = "12345786" };
            await accountsController.CreateUser(createUserInfo);
        }
