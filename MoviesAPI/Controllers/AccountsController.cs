...
namespace MoviesAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserToken>> CreateUser([FromBody] CreateUserInfoDTO model)
        {
        ...
        public async Task<ActionResult<UserDTO>> GetUserInfoByEmail([FromBody] UserDTO userDTO)
        {
            var identityUser = await _userManager.FindByEmailAsync(userDTO.EmailAddress);
